...
class RealAteeqqDetector:
    ...
    def check_if_image_is_ai(self, image_path: str) -> Dict[str, Any]:
        ...
        is_human = (
            ...
            "natural" in label_lower or
            label_lower == "0"  # Some models use 0 for human, 1 for AI
        )
        ...
        if is_ai:
            ...
            # Fallback: assume higher confidence means AI
            if confidence > 0.5:
                prediction = "AI Generated"
                ai_prob = confidence
                real_prob = 1 - confidence
