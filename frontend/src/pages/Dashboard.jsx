  ...
  const tools = [
    {
      ...
      name: 'Smart Crop',
      icon: Crop,
      description: 'AI-powered cropping with subject preservation',
    ...
    },
    {
      ...
      name: 'Outpaint',
      icon: Expand,
      description: 'Extend images with AI-generated backgrounds',
    ...
    },
    {
      ...
      icon: Search,
      description: 'Detect if image is morphed/edited',
    ...
    },
    {
      ...
      icon: Zap,
      description: 'Run all tools in sequence',
